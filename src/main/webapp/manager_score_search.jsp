...
<main id="main">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 fs-7">
                            ...
                            <li class="breadcrumb-item">成绩管理 / 成绩查询</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="bg-light">
        <div class="container">
            <form class="form-horizontal" action="adminStudentScoreServlet" method="post">
                <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label" for="studentID">学生ID:</label>
                            <input type="text" id="studentID" name="studentID" class="form-control" placeholder="请输入学生ID">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1" aria-labelledby="bsbSidebarLabel1">
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link link-primary active" aria-current="page" href="manager_score_search.jsp">
                    <div class="nav-link-icon text-primary-emphasis">
                        <i class="bi bi-arrow-right-short"></i>
                    </div>
