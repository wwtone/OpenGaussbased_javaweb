...
<header id="header" class="bg-white border-bottom border-light-subtle sticky-top bsb-tpl-header-sticky">
    <nav class="navbar navbar-expand-md bsb-navbar-3 bsb-tpl-navbar-sticky" data-bsb-sticky-target="#header">
        <div class="container">
            ...
            <a class="navbar-brand" href="manager_index.jsp.jsp">
...
<main id="main">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 fs-7">
                            <li class="breadcrumb-item"><a class="link-primary text-decoration-none" href="manager_index.jsp.jsp">Home</a></li>
                            <li class="breadcrumb-item">课程管理 / 班级课程开设</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="bg-light">
        <div class="container">
            <form class="form-horizontal" action="adminClassScheduleServlet" method="post">
                <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label" for="classId">班级编号:</label>
                            <input type="text" id="classId" name="classId" class="form-control" placeholder="请输入班级编号">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label" for="className">班级名称:</label>
                            <input type="text" id="className" name="className" class="form-control" placeholder="请输入班级名称">
                        </div>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="classScheduleTable">
                    ...
                    <tbody>
                    <c:forEach var="classSchedule" items="${classScheduleList}">
                        <tr>
                            <td>${classSchedule.courseName}</td>
                            <td>${classSchedule.courseID}</td>
                            <td>${classSchedule.courseHours}</td>
                            <td>${classSchedule.credit}</td>
                            <td>${classSchedule.examForm}</td>
                            <td>${classSchedule.classID}</td>
                            <td>${classSchedule.className}</td>
                            <td>${classSchedule.teacherName}</td>
                        </tr>
                    </c:forEach>
...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1" aria-labelledby="bsbSidebarLabel1">
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link link-primary active" aria-current="page" href="manager_classSchedule.jsp">
                    <div class="nav-link-icon text-primary-emphasis">
                        <i class="bi bi-arrow-right-short"></i>
                    </div>
