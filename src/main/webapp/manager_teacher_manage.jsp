...
<main id="main">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 fs-7">
                            ...
                            <li class="breadcrumb-item">信息管理 / 教师信息管理</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="py-3 py-md-4 py-xl-5 bg-light">
        <div class="container py-3 py-md-4 py-xl-5 bg-light">
            ...
            <!-- Search and Add Form -->
            <div>
                <form class="form-inline mb-3" action="searchTeacherServlet" method="post">
                    <!-- Search fields -->
                    <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fas fa-id-card"></i>教师编号</div>
                        </div>
                        <input type="text" class="form-control" id="teacherID" name="teacherID" placeholder="请输入教师编号">
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fas fa-user"></i>教师姓名</div>
                        </div>
                ...
                <!-- Add Form -->
                <h4>添加教师</h4>
                <form action="addTeacherServlet" method="post" class="mb-3">
                    <!-- Fields for adding a teacher -->
                    <div class="form-row align-items-center">
                        <div class="col-auto">
                            <input type="text" class="form-control mb-2" id="addTeacherID" placeholder="教师编号" name="teacherID" required>
                        </div>
                        <div class="col-auto">
                            <input type="text" class="form-control mb-2" id="addTeacherName" placeholder="教师姓名" name="teacherName" required>
                        </div>
                        <div class="form-group">
                            <label for="updateTeacherGender">性别</label>
                            <input type="text" class="form-control" id="updateTeacherGender" name="teacherGender" required>
                        </div>
                        <div class="form-group">
                            <label for="updateTeacherAge">年龄</label>
                            <input type="number" class="form-control" id="updateTeacherAge" name="teacherAge" required>
                        </div>
                        <div class="form-group">
                            <label for="updateTitle">职称</label>
                            <input type="text" class="form-control" id="updateTitle" name="title" required>
                        </div>
                        <div class="form-group">
                            <label for="updateContactNumber">联系电话</label>
                            <input type="text" class="form-control" id="updateContactNumber" name="contactNumber" required>
                        </div>
                    </div>
                        <!-- Additional fields as needed -->
                        <div class="col-auto">
                            <button type="submit" class="btn btn-outline-accent mb-2">添加</button>
                        </div>
                </form>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="deleteTeacherServlet" method="post" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn btn-outline-danger" onclick="return confirm('确定要删除这个教师吗？')">删除</button>
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1" aria-labelledby="bsbSidebarLabel1">
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link link-primary active" aria-current="page" href="manager_teacher_manage.jsp">
                    <div class="nav-link-icon text-primary-emphasis">
                        <i class="bi bi-arrow-right-short"></i>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#updateTeacherModal').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var modal = $(this);
            modal.find('#updateTeacherID').val(button.data('teacherid'));
            modal.find('#updateTeacherName').val(button.data('teachername'));
            modal.find('#updateTeacherGender').val(button.data('teachergender'));
            modal.find('#updateTeacherAge').val(button.data('teacherage'));
            modal.find('#updateTitle').val(button.data('title'));
            modal.find('#updateContactNumber').val(button.data('contactnumber'));
        });
    });
</script>
</body>
