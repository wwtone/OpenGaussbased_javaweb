...
<main id="main">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 fs-7">
                            ...
                            <li class="breadcrumb-item">信息管理 / 师生信息导入</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="pb-3 pb-md-4 pb-xl-5 bg-light">
        ...
        <div class="container container-main">
            <h3 class="text-center mb-2">信息导入</h3>
            <form action="adminImport" method="post" enctype="multipart/form-data">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <a href="adminDownload" class="btn btn-dark btn-lg">
                            <i class="bi bi-cloud-download" style="font-size: 1.2rem;"></i> 下载模板
                        </a>
                        <div class="input-group input-group-sm mx-2">
                    <span class="input-group-text">
                        <i class="bi bi-file-earmark-arrow-up" style="font-size: 1.2rem;"></i>
                    </span>
                            <input type="file" id="fileUpload" name="fileUpload" class="form-control" accept=".xlsx, .xls">
                        </div>
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="bi bi-upload" style="font-size: 1.2rem;"></i> 上传
                        </button>
                    </div>
                </div>
            </form>
...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1" aria-labelledby="bsbSidebarLabel1">
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link link-primary active" aria-current="page" href="manager_import_info.jsp">
                    <div class="nav-link-icon text-primary-emphasis">
                        <i class="bi bi-arrow-right-short"></i>
                    </div>
