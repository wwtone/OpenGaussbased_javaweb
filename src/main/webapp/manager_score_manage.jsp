...
<main id="main">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 fs-7">
                            ...
                            <li class="breadcrumb-item">成绩管理 / 平均成绩查询</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="bg-light">
        <div class="container">
            <form class="form-horizontal" action="adminScoreAvgServlet" method="post">
                <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label" for="courseID">教师编号:</label>
                            <input type="text" id="teacherID" name="teacherID" class="form-control" placeholder="请输入教师编号">
                        </div>
                    </div>
            ...
            <div class="table-responsive">
                <table id="avgScoreTable" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                        <th>教师ID</th>
                        <th>课程编号</th>
                    ...
                    <c:if test="${empty results}">
                        <tr>
                            <td colspan="5" class="text-center">没有找到记录</td>
                        </tr>
                    </c:if>
                    </tbody>
                </table>
...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1" aria-labelledby="bsbSidebarLabel1">
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link link-primary active" aria-current="page" href="manager_score_manage.jsp">
