...
<main id="main">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 fs-7">
                            ...
                            <li class="breadcrumb-item">个人信息/教师课表</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="bg-light">
        <div class="container">
            <form class="form-horizontal"  action="TeacherScheduleServlet" method="post">
                <div class="container">
...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1" aria-labelledby="bsbSidebarLabel1">
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link link-primary active" aria-current="page" href="stu_teacherSchedule.jsp">
                    <div class="nav-link-icon text-primary-emphasis">
                        <i class="bi bi-arrow-right-short"></i>
                    </div>
