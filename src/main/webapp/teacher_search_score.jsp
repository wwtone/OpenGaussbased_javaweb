...
<main id="main">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 fs-7">
                            ...
                            <li class="breadcrumb-item">信息查询/成绩查询</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <!-- Section - Bootstrap Brain Component -->
        <section class="bg-light">
            <div class="container">
                <form class="form-horizontal"  action="teacher_search_scoreServlet" method="post">
                    <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="studentId" name="studentId" class="form-control" placeholder="请输入学号">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label" for="courseCode">课程编号:</label>
                                <input type="text" id="courseCode" name="courseCode" class="form-control" placeholder="请输入课程编号">
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <c:forEach items="${results}" var="ret">
                            <tr>
                                <td>${ret.studentID}</td>
                                <td>${ret.studentName}</td>
                                <td>${ret.courseName}</td>
                                <td>${ret.courseID}</td>
                                <td>${ret.semester}</td>
                                <td>${ret.score}</td>
                            </tr>
                        ...
                        <c:if test="${empty results}">
                            <tr>
                                <td colspan="6" class="text-center">没有找到记录</td>
                            </tr>
                        </c:if>
                        </tbody>
                    </table>
...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1" aria-labelledby="bsbSidebarLabel1">
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link link-secondary" aria-current="page" href="updateScore.jsp">
            ...
            <li class="nav-item">
                <a class="nav-link link-primary active" aria-current="page" href="teacher_search_score.jsp">
                    <div class="nav-link-icon text-primary-emphasis">
                        <i class="bi bi-arrow-right-short"></i>
                    </div>
