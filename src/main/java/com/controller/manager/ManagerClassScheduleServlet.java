...
@WebServlet("/adminClassScheduleServlet")
public class ManagerClassScheduleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 转发请求到JSP页面
        RequestDispatcher dispatcher = request.getRequestDispatcher("manager_classSchedule.jsp");
